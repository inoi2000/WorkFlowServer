    ...
    public CommandLineRunner dataLoader(
        ...
        return args -> {
            ...
            announcementRepository.save(new Announcement(
                    ...
                    new FileKey(UUID.randomUUID(), "8c12b0b6-3c94-4ed1-9dc2-4a9eb08266cb.png")
            ));
            ...
            announcementRepository.save(new Announcement(
                    ...
                    LocalDateTime.now(),
                    "Просьба всем сотрудникам 10.05.2026 прибыть в главный офис для прохождения плановго совещания. Всем спасибо!",
                    null
            ));
        };
    }
