...
import com.petproject.workflow_server.api.service.EmployeeService;
...
public class EmployeeController {
    ...
    public Absence createAbsenceToEmployee(
            @PathVariable("employeeId") String employeeId,
            @RequestBody Absence absence) {
        return employeeService.addAbsenceToEmployee(UUID.fromString(employeeId), absence);
    }
